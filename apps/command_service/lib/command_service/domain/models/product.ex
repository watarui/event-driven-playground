defmodule CommandService.Domain.Models.Product do
  ...
  def decrement_stock(%__MODULE__{stock_quantity: current} = product, quantity) when quantity > 0 do
  ...
  def increment_stock(%__MODULE__{stock_quantity: current} = product, quantity) when quantity > 0 do
