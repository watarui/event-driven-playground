defmodule CommandService.Infrastructure.Firestore.CategoryRepository do
  @moduledoc """
  ...
  defp rebuild_aggregate_from_events(events) do
    Enum.reduce(events, CategoryAggregate.new(), fn event, aggregate ->
      CategoryAggregate.apply_event(aggregate, event)
    end)
  end
end