  ...
  defp subscribe_to_topic(pid, topic, state) do
    ...
    new_state = 
      if Map.has_key?(state.subscription_workers, worker_key) do
        ...
        %{state | subscription_workers: Map.put(state.subscription_workers, worker_key, worker_pid)}
      end
    ...
    final_state = %{new_state | subscriptions: Map.put(new_state.subscriptions, topic, new_subscribers)}
